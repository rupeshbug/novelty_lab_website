    ...
    <>
      ...
      <main className="min-h-screen text-white">
        ...
        <section className="relative px-6 md:px-12 max-w-5xl mx-auto">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-10 md:p-16 border border-white/10 shadow-lg relative z-20">
            <div className="flex items-center gap-4 mb-6">
              <Rocket className="w-10 h-10 text-indigo-400" />
              <h2 className="text-4xl font-bold text-gradient bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
        ...
        <section className="relative py-20 px-6 md:px-12 max-w-5xl mx-auto">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-10 md:p-16 border border-white/10 shadow-lg relative z-20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-4xl font-bold text-gradient bg-gradient-to-r from-teal-400 via-cyan-400 to-sky-400 bg-clip-text text-transparent">
        ...
        <section className="relative px-6 md:px-12 max-w-5xl mx-auto mb-20">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-10 md:p-16 border border-white/10 shadow-lg relative z-20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-4xl font-bold text-gradient bg-gradient-to-r from-yellow-400 via-orange-400 to-rose-400 bg-clip-text text-transparent">
