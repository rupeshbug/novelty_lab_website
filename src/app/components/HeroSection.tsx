...
export default function Hero() {
  return (
    <section className="py-16 px-6 md:px-40 md:py-20">
      <div className="mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="text-center w-full md:w-3/5 md:text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 justify-items-center gap-4 mb-10">
